...
ClapTrap::ClapTrap ( void ): _name(), _type("ClapTrap"), _hp(10), _energy(10), _ad(0), _hpBase(10) {
	std::cout << "Default constructor called" << std::endl;
}

ClapTrap::ClapTrap ( std::string name ): _name(name), _type("ClapTrap"), _hp(10), _energy(10), _ad(0), _hpBase(10) {
